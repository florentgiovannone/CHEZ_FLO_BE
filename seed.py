...
with app.app_context():
    ...
    try:
        ...
        Carousel_one = CarouselModel(
            carousel_url=(
                "https://media.houseandgarden.co.uk/"
                "photos/6548bac4ae920bdd9a97b4d2/16:9/w_2580,c_limit/"
                "Restaurant%20Interior%20(Credit%20Ben%20Carpenter).jpg"
            ),
            content=Content,
        )
        Carousel_two = CarouselModel(
            carousel_url=(
                "https://www.thisisamber.co.uk/"
                "wp-content/uploads/2018/02/160-amb-23-2r-203-1-1600x708.jpg"
            ),
            content=Content,
        )
        Carousel_three = CarouselModel(
            carousel_url=(
                ...
                "siteassets/restaurants--bars/claridges-restaurant/new-2023/"
                "claridges-restaurant-hero-1920_720.jpg"
            ),
            content=Content,
        )
        ...
        Breakfast_menus = MenusModel(
            ...
            menus_url=(
                "https://res.cloudinary.com/ded4jhx7i/"
                "image/upload/v1746624683/REX_Breakfast_20241119V001_pwlgsy.pdf"
            ),
            content=Content,
        )
        Lunch_menus = MenusModel(
            ...
            menus_url=(
                "https://res.cloudinary.com/ded4jhx7i/"
                "image/upload/v1746624897/REX_Lunch_20250422V002_Spring_Menu_ovnzlt.pdf"
            ),
            content=Content,
        )
        Dinner_menus = MenusModel(
            ...
            menus_url=(
                "https://res.cloudinary.com/ded4jhx7i/"
                "image/upload/v1746624894/REX_Dinner_20250422V002_Spring_Menu_ei93vd.pdf"
            ),
            content=Content,
        )
        Desserts_menus = MenusModel(
            ...
            menus_url=(
                "https://res.cloudinary.com/ded4jhx7i/"
                "image/upload/v1746624762/desserts_lsacmw_jppkyk.pdf"
            ),
            content=Content,
        )
        Winelist_menus = MenusModel(
            ...
            menus_url=(
                "https://res.cloudinary.com/ded4jhx7i/"
                "image/upload/v1746624798/Swan-Wine-List_oevrzp.pdf"
            ),
            content=Content,
        )
        Cocktail_menus = MenusModel(
            ...
            menus_url=(
                "https://res.cloudinary.com/ded4jhx7i/"
                "image/upload/v1746624674/"
                "The-Savoy-American-Bar_-American-Bar-Liquid-Moments_1_kjlreb.pdf"
            ),
            content=Content,
        )
